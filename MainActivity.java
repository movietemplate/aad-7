    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fragment1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(android.support.constraint.R.id.layout, first);
        ...
        findViewById(R.id.fragment2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(android.support.constraint.R.id.layout, second);
                fragmentTransaction.commit();
            }
        });
    }
